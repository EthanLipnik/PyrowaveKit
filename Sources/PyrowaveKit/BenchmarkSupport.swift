...
public enum PyrowaveBenchmarkRunner {
    ...
    public static let pyrowaveImplementationNote = "Hard-cutover v2 stream with Metal plane pad/crop, DWT/iDWT, block quantization, sparse packet byte-cost prefiltering, sparse decode apply, rate-control stats, bucket resolve, and savings prefix, 32x32 sparse packets, and optional frame-size cap. \(timedBenchmarkScopeNote)"
